...
export class addUnitName1586707591102 implements MigrationInterface {
    name = 'addUnitName1586707591102'

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "temporary_unit" ("id" varchar PRIMARY KEY NOT NULL, "isProfilesSelectable" boolean NOT NULL DEFAULT (1), "notes" text NOT NULL, "primaryDetailsId" varchar, "secondaryDetailsId" varchar, "name" varchar NOT NULL DEFAULT (''), CONSTRAINT "UQ_f5154dc9fcd7dd967bda1daead7" UNIQUE ("primaryDetailsId"), CONSTRAINT "UQ_c433e3185ac659eff4003063ca7" UNIQUE ("secondaryDetailsId"), CONSTRAINT "FK_f5154dc9fcd7dd967bda1daead7" FOREIGN KEY ("primaryDetailsId") REFERENCES "details" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_c433e3185ac659eff4003063ca7" FOREIGN KEY ("secondaryDetailsId") REFERENCES "details" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "unit" ("id" varchar PRIMARY KEY NOT NULL, "isProfilesSelectable" boolean NOT NULL DEFAULT (1), "notes" text NOT NULL, "primaryDetailsId" varchar, "secondaryDetailsId" varchar, CONSTRAINT "UQ_f5154dc9fcd7dd967bda1daead7" UNIQUE ("primaryDetailsId"), CONSTRAINT "UQ_c433e3185ac659eff4003063ca7" UNIQUE ("secondaryDetailsId"), CONSTRAINT "FK_f5154dc9fcd7dd967bda1daead7" FOREIGN KEY ("primaryDetailsId") REFERENCES "details" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_c433e3185ac659eff4003063ca7" FOREIGN KEY ("secondaryDetailsId") REFERENCES "details" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`, undefined);
