...
export class addImageLink1586354854458 implements MigrationInterface {
  name = 'addImageLink1586354854458';

  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(
      `ALTER TABLE "details" ADD "image" varchar NOT NULL default ""`,
      undefined,
    );
    await queryRunner.query(
      `ALTER TABLE "entry" ADD "image" varchar NOT NULL default ""`,
      undefined,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `CREATE TABLE "entry" ("id" varchar PRIMARY KEY NOT NULL, "isc" varchar, "name" varchar NOT NULL, "sectorials" text NOT NULL, "primaryUnitId" varchar NOT NULL, CONSTRAINT "UQ_ee3cc89ae850a57f77dc10fd069" UNIQUE ("primaryUnitId"), CONSTRAINT "FK_ee3cc89ae850a57f77dc10fd069" FOREIGN KEY ("primaryUnitId") REFERENCES "unit" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`,
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "details" ("id" varchar PRIMARY KEY NOT NULL, "isc" varchar, "classification" varchar NOT NULL, "unitType" varchar, "orderType" varchar NOT NULL, "hackable" boolean NOT NULL DEFAULT (0), "impetuous" varchar, "cube" varchar, "mov" varchar NOT NULL, "cc" varchar NOT NULL, "bs" varchar NOT NULL, "ph" varchar NOT NULL, "wip" varchar NOT NULL, "arm" varchar NOT NULL, "bts" varchar NOT NULL, "w" varchar NOT NULL, "structure" boolean NOT NULL DEFAULT (0), "ava" text NOT NULL, "name" varchar NOT NULL, "s" varchar NOT NULL)`,
      undefined,
    );
    await queryRunner.query(
